...
public class CommonAspect {
	...
	public void footerDataSend() {
		...
		HttpServletRequest request=((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();	// java에서 현재 사용 중인 request를 가져온다
	...
	public Object logData(ProceedingJoinPoint jp) throws Throwable {
		...
		obj=jp.proceed();
		System.out.println(jp.getSignature().getName()+":메소드에 수행 종료");
