...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      <ul class="inline">
        <li><input type=text name=id size=10 placeholder="아이디"></li>
        <li><input type=password name=pwd size=15 placeholder="비밀번호"></li>
...
<div class="wrapper row2">
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      ...
      <li><a href="../movie/movie_rank.do">영화 순위</a></li>
    </ul>
    <!-- ################################################################################################ --> 
  </nav>
</div>
