...
<div class="container">
	...
	<div class="row">
		<div class="text-center">
			...
			<b-button variant="outline-warning" @click="musicGetData(4)">OST</b-button>	
...
// component => Vue 통신 eventBus
	...
	Vue.component('music', {
	    ...
	    template:
	        ...
	        '<td class="text-center"><img :src="vo.poster" style="width:30px;height:30px"></td>' + // vo.poster 변수 앞에 콜론(:) 추가
	        '<td>{{ vo.title }}</td>' +
	        '<td>{{ vo.singer }}</td>' +
