...
@RestController
@RequestMapping("food/")
@CrossOrigin("http://localhost:3000")	// port 번호가 틀릴 시엔 CrossOrigin으로 허락해줘야 가능하다
public class FoodRestController {
	...
	public List<CategoryEntity> food_category1() {
		...
		// Boot에선 return값이 자동으로 json형식으로 바뀐다
	}
	...
	public FoodEntity food_listData (int fno){
	...
	@RequestMapping("food_page_react")
