...
<div class="row row1">
	...
	<table class="table">
		...
		<td colspan="4" class="text-right">
			<a href="../databoard/update.do?no=${vo.no }" class="btn btn-sm btn-danger">수정</a>
			<a href="../databoard/delete.do?no=${vo.no }" class="btn btn-sm btn-danger">삭제</a>
			<a href="../databoard/list.do" class="btn btn-sm btn-danger">목록</a>	
		</td>
		</tr>
	</table>
</div>
